(function ($) {
  ...
  Drupal.behaviors.hba_theme = {
    attach: function (context, settings) {
      ...
      if ($('body.page-node-add.page-node-add-trip').length === 0) { // sense aquesta condició, error js quan s'obre un jQuery UI pop-up (add trip)
      ...
      // Codi només per la plate
      if ($('body.page-plate').length > 0) {
